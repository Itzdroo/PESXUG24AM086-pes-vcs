...
// Recursive helper: builds a tree for entries that share a common prefix at this depth
// entries: array of IndexEntry pointers
// count: number of entries
// prefix: current directory prefix (e.g., "src/") or "" for root
